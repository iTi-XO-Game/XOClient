...
public class ActiveGame {
    ...
    public void makeSender() {
        if (playerOid == UserSession.getUserId()) {
            receiver = playerXid == sender.getId() ? sender : receiver;
            sender = UserSession.currentPlayer;
        } if (playerXid == UserSession.getUserId()) {
            receiver = playerOid == sender.getId() ? sender : receiver;
            sender = UserSession.currentPlayer;
        }
    }
}